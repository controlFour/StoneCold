...
void DisplayManager::createSettingsScreen() {
    ...
    lv_obj_align(_settingsItems[SETTINGS_PID], LV_ALIGN_CENTER, 0, -30);
    ...
    lv_obj_align(_settingsItems[SETTINGS_CURRENT], LV_ALIGN_CENTER, 0, 0);
    ...
    lv_obj_align(_settingsItems[SETTINGS_POWER], LV_ALIGN_CENTER, 0, 30);
    ...
    lv_obj_align(_settingsItems[SETTINGS_FANS], LV_ALIGN_CENTER, 0, 60);
...
void DisplayManager::updatePIDScreen(PIDMenuItem selectedItem, bool editing, bool hasChanges) {
    ...
    // Build list of visible items (skip SAVE if no changes)
